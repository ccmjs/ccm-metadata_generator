{function a(){window.ccm[v].component(component)}var component={name:"metadata_generator",version:[0,3,0],ccm:"https://ccmjs.github.io/ccm/versions/ccm-18.0.5.min.js",config:{html:{main:{id:"main",class:"container bootfont",inner:[{inner:`
              <div class="row">
                <div class="col-md-8">
              ...
              `}]}},css:["ccm.load",["https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css","https://cdnjs.cloudflare.com/ajax/libs/balloon-css/0.5.0/balloon.min.css","https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.4/css/selectize.default.min.css","https://ccmjs.github.io/ccm-metadata_generator/css/default.css"]],js:["ccm.load",["https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js","https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js","https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.4/js/standalone/selectize.min.js"]],no_bootstrap_container:!1,embedded:!1,categories:["Anthropology","Art","Astronomy","Biology","Chemistry","Classic culture","Computer Science","Craft","Design","Economy","Emotional education","Engineering","English","Environment","Experimental sciences","French","General Studies","Geography","Geology","German","Health","History","Italian","Language","Latin","Laws","Literature","Mathematics","Music","Others","Pedagogy","Philosophy","Physical education","Physics","Politics","Psychology","Religion","Russian","Social sciences","Spanish","Sport","Teaching Tools","Technical Drawing","Technology","Values education","Vocational education"]},Instance:function(){const a=this;let b={title:!1,version:!1,creator:!1,subject:!1,description:!1,publisher:!1,contributor:!1,date:!1,format:!1,identifier:!1,"path-component":!1,"path-config":!1,"config-key":!1,source:!1,language:!1,license:{self:!1,software:!1,content:!1},tags:!1,category:!1,bloomTaxonomy:!1},c={metaFormat:"ccm-meta",metaVersion:"1.0.0",title:"",version:"",creator:"",subject:"",description:"",publisher:"",contributor:"",date:new Date().toISOString().split("T")[0],format:"application/javascript",identifier:"","path-component":"","path-config":"","config-key":"",source:"",language:"",license:{software:"",content:""},tags:"",category:"",bloomTaxonomy:""},d={};const e={ab:"Abkhazian",aa:"Afar",af:"Afrikaans",ak:"Akan",sq:"Albanian",am:"Amharic",ar:"Arabic",an:"Aragonese",hy:"Armenian",as:"Assamese",av:"Avaric",ae:"Avestan",ay:"Aymara",az:"Azerbaijani",bm:"Bambara",ba:"Bashkir",eu:"Basque",be:"Belarusian",bn:"Bengali (Bangla)",bh:"Bihari",bi:"Bislama",bs:"Bosnian",br:"Breton",bg:"Bulgarian",my:"Burmese",ca:"Catalan",ch:"Chamorro",ce:"Chechen",ny:"Chichewa, Chewa, Nyanja",zh:"Chinese",cv:"Chuvash",kw:"Cornish",co:"Corsican",cr:"Cree",hr:"Croatian",cs:"Czech",da:"Danish",dv:"Divehi, Dhivehi, Maldivian",nl:"Dutch",dz:"Dzongkha",en:"English",eo:"Esperanto",et:"Estonian",ee:"Ewe",fo:"Faroese",fj:"Fijian",fi:"Finnish",fr:"French",ff:"Fula, Fulah, Pulaar, Pular",gl:"Galician",gd:"Gaelic (Scottish)",gv:"Gaelic (Manx)",ka:"Georgian",de:"German",el:"Greek",kl:"Greenlandic",gn:"Guarani",gu:"Gujarati",ht:"Haitian Creole",ha:"Hausa",he:"Hebrew",hz:"Herero",hi:"Hindi",ho:"Hiri Motu",hu:"Hungarian",is:"Icelandic",io:"Ido",ig:"Igbo",id:"Indonesian",ia:"Interlingua",ie:"Interlingue",iu:"Inuktitut",ik:"Inupiak",ga:"Irish",it:"Italian",ja:"Japanese",jv:"Javanese",kn:"Kannada",kr:"Kanuri",ks:"Kashmiri",kk:"Kazakh",km:"Khmer",ki:"Kikuyu",rw:"Kinyarwanda (Rwanda)",rn:"Kirundi",ky:"Kyrgyz",kv:"Komi",kg:"Kongo",ko:"Korean",ku:"Kurdish",kj:"Kwanyama",lo:"Lao",la:"Latin",lv:"Latvian (Lettish)",li:"Limburgish (Limburger)",ln:"Lingala",lt:"Lithuanian",lu:"Luga-Katanga",lg:"Luganda, Ganda",lb:"Luxembourgish",mk:"Macedonian",mg:"Malagasy",ms:"Malay",ml:"Malayalam",mt:"Maltese",mi:"Maori",mr:"Marathi",mh:"Marshallese",mo:"Moldavian",mn:"Mongolian",na:"Nauru",nv:"Navajo",ng:"Ndonga",nd:"Northern Ndebele",ne:"Nepali",no:"Norwegian",nb:"Norwegian bokm\xE5l",nn:"Norwegian nynorsk",ii:"Nuosu",oc:"Occitan",oj:"Ojibwe",cu:"Old Church Slavonic, Old Bulgarian",or:"Oriya",om:"Oromo (Afaan Oromo)",os:"Ossetian",pi:"P\u0101li",ps:"Pashto, Pushto",fa:"Persian (Farsi)",pl:"Polish",pt:"Portuguese",pa:"Punjabi (Eastern)",qu:"Quechua",rm:"Romansh",ro:"Romanian",ru:"Russian",se:"Sami",sm:"Samoan",sg:"Sango",sa:"Sanskrit",sr:"Serbian",sh:"Serbo-Croatian",st:"Sesotho",tn:"Setswana",sn:"Shona",sd:"Sindhi",si:"Sinhalese",ss:"Siswati",sk:"Slovak",sl:"Slovenian",so:"Somali",nr:"Southern Ndebele",es:"Spanish",su:"Sundanese",sw:"Swahili (Kiswahili)",sv:"Swedish",tl:"Tagalog",ty:"Tahitian",tg:"Tajik",ta:"Tamil",tt:"Tatar",te:"Telugu",th:"Thai",bo:"Tibetan",ti:"Tigrinya",to:"Tonga",ts:"Tsonga",tr:"Turkish",tk:"Turkmen",tw:"Twi",ug:"Uyghur",uk:"Ukrainian",ur:"Urdu",uz:"Uzbek",ve:"Venda",vi:"Vietnamese",vo:"Volap\xFCk",wa:"Wallon",cy:"Welsh",wo:"Wolof",fy:"Western Frisian",xh:"Xhosa",yi:"Yiddish",yo:"Yoruba",za:"Zhuang, Chuang",zu:"Zulu"};this.start=async()=>{function f(a){n.querySelector("#include"+k(a.toLowerCase())).addEventListener("change",function(){b[a]=this.checked,j()}),n.querySelector("#input"+k(a.toLowerCase())).addEventListener("input",function(){c[a]=this.value,j()})}function g(a){b[a]?d[a]=c[a]:delete d[a]}function h(){b.date?/([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01]))/.test(c.date)?d.date=c.date:delete d.date:delete d.date}function i(){b.license.self?(d.license={},b.license.software?d.license.software=c.license.software:delete d.license.software,b.license.content?d.license.content=c.license.content:delete d.license.content):delete d.license}function j(){d={},d.metaFormat=c.metaFormat,d.metaVersion=c.metaVersion,g("title"),g("version"),g("creator"),g("subject"),g("description"),g("publisher"),g("contributor"),h(),g("format"),g("identifier"),g("path-component"),g("path-config"),g("config-key"),g("source"),g("language"),i(),g("tags"),g("category"),g("bloomTaxonomy");const b=JSON.stringify(d,null,2);return a.embedded||(n.querySelector("#resultDisplay").innerHTML=b),b}function k(a){return a.charAt(0).toUpperCase()+a.slice(1)}function l(){return"10000000-1000-4000-8000-100000000000".replace(/[018]/g,a=>(a^crypto.getRandomValues(new Uint8Array(1))[0]&15>>a/4).toString(16))}function m(a){const b=document.createElement("textarea");b.value=a,b.setAttribute("readonly",""),b.style.position="absolute",b.style.left="-9999px",document.body.appendChild(b);const c=!!(0<document.getSelection().rangeCount)&&document.getSelection().getRangeAt(0);b.select(),document.execCommand("copy"),document.body.removeChild(b),c&&(document.getSelection().removeAllRanges(),document.getSelection().addRange(c))}a.no_bootstrap_container&&(this.html.main.class="");const n=this.ccm.helper.html(this.html.main,{});this.element.appendChild(n),a.embedded&&n.querySelectorAll(".removeOnEmbed").forEach(a=>{a.parentNode.removeChild(a)}),n.querySelectorAll(".example-text").forEach(a=>{a.addEventListener("click",function(a){a.preventDefault(),m(this.innerHTML.replace("Example: ",""))})});let o=[];Object.keys(e).forEach(a=>{o.push({value:a,label:e[a]})});const p=$(n.querySelector("#inputLanguage")).selectize({delimiter:",",persist:!1,create:!1,plugins:["remove_button"],maxItems:null,placeholder:"Select languages...",valueField:"value",labelField:"label",searchField:"label",options:o})[0].selectize;const q=$(n.querySelector("#inputTags")).selectize({delimiter:",",persist:!1,create:!0,plugins:["remove_button"],maxItems:null,placeholder:"Add tags...",valueField:"value",labelField:"value",searchField:"value",options:[]})[0].selectize;let r=[];a.categories.forEach(a=>{r.push({value:a})});const s=$(n.querySelector("#inputCategory")).selectize({persist:!1,create:!1,maxItems:1,placeholder:"Select a category that suits the resource",valueField:"value",labelField:"value",searchField:"value",options:r})[0].selectize;const t=$(n.querySelector("#inputBloomTaxonomy")).selectize({persist:!1,create:!1,maxItems:1,placeholder:"Select the highest level that applies to the resource",valueField:"value",labelField:"value",searchField:"value",options:[{value:"Remember"},{value:"Understand"},{value:"Apply"},{value:"Analyze"},{value:"Evaluate"},{value:"Create"}]})[0].selectize;j(),n.querySelector("#activateAllFields").addEventListener("click",function(){n.querySelectorAll(".metaFieldCheckbox").forEach(a=>{a.checked=!0;const b=document.createEvent("HTMLEvents");b.initEvent("change",!1,!0),a.dispatchEvent(b)}),j()}),n.querySelector("#deactivateAllFields").addEventListener("click",function(){n.querySelectorAll(".metaFieldCheckbox").forEach(a=>{a.checked=!1;const b=document.createEvent("HTMLEvents");b.initEvent("change",!1,!0),a.dispatchEvent(b)}),j()}),a.embedded||n.querySelector("#buttonCopyResultToClipboard").addEventListener("click",function(a){a.preventDefault(),m(j())}),f("title"),f("version"),f("creator"),f("subject"),f("description"),f("publisher"),f("contributor"),f("date"),f("format"),f("identifier"),f("path-component"),f("path-config"),f("config-key"),f("source"),n.querySelector("#buttonGenerateIdentifier").addEventListener("click",function(){const a=n.querySelector("#inputIdentifier");a.value=l();const b=document.createEvent("HTMLEvents");b.initEvent("input",!1,!0),a.dispatchEvent(b),j()}),n.querySelector("#includeLanguage").addEventListener("change",function(){b.language=this.checked,j()}),p.on("change",()=>{c.language=p.getValue().join(", "),j()}),n.querySelector("#includeLicenses").addEventListener("change",function(){b.license.self=this.checked,j()}),n.querySelector("#includeSoftwareLicense").addEventListener("change",function(){b.license.software=this.checked,j()}),n.querySelector("#includeContentLicense").addEventListener("change",function(){b.license.content=this.checked,j()}),Array.from(n.querySelectorAll("input[name=software_license_choose]")).forEach(a=>{a.addEventListener("change",function(){switch(this.value){case"AGPL":c.license.software="AGPL-3.0-only";break;case"GPL":c.license.software="GPL-3.0-only";break;case"LGPL":c.license.software="LGPL-3.0-only";break;case"MPL":c.license.software="MPL-2.0";break;case"Apache":c.license.software="Apache-2.0";break;case"MIT":c.license.software="MIT";break;case"Unlicense":c.license.software="Unlicense";break;case"other":c.license.software=n.querySelector("#other_software_license").value;break;default:c.license.software="";}j()})}),n.querySelector("#other_software_license").addEventListener("input",function(){n.querySelector("#software_license_choose_8").checked&&(c.license.software=this.value,j())}),Array.from(n.querySelectorAll("input[name=content_license_choose]")).forEach(a=>{a.addEventListener("change",function(){c.license.content="other"===this.value?n.querySelector("#other_content_license").value:this.value,j()})}),n.querySelector("#other_content_license").addEventListener("input",function(){n.querySelector("#content_license_choose_7").checked&&(c.license.content=this.value,j())}),n.querySelector("#includeTags").addEventListener("change",function(){b.tags=this.checked,j()}),q.on("change",()=>{c.tags=q.getValue().join(", "),j()}),n.querySelector("#includeCategory").addEventListener("change",function(){b.category=this.checked,j()}),s.on("change",()=>{c.category=s.getValue(),j()}),n.querySelector("#includeBloomTaxonomy").addEventListener("change",function(){b.bloomTaxonomy=this.checked,j()}),t.on("change",()=>{c.bloomTaxonomy=t.getValue(),j()})},this.getValue=()=>this.ccm.helper.clone(d),this.submit=b=>{b&&b.preventDefault(),a.ccm.helper.onFinish(a)}}},f="ccm."+component.name+(component.version?"-"+component.version.join("."):"")+".js";if(window.ccm&&null===window.ccm.files[f])window.ccm.files[f]=component;else{var n=window.ccm&&window.ccm.components[component.name];n&&n.ccm&&(component.ccm=n.ccm),"string"==typeof component.ccm&&(component.ccm={url:component.ccm});var v=component.ccm.url.split("/").pop().split("-");if(1<v.length?(v=v[1].split("."),v.pop(),"min"===v[v.length-1]&&v.pop(),v=v.join(".")):v="latest",window.ccm&&window.ccm[v])a();else{var e=document.createElement("script");document.head.appendChild(e),component.ccm.integrity&&e.setAttribute("integrity",component.ccm.integrity),component.ccm.crossorigin&&e.setAttribute("crossorigin",component.ccm.crossorigin),e.onload=function(){a(),document.head.removeChild(e)},e.src=component.ccm.url}}}